...
| **Security** | [![OpenSSF Scorecard](https://api.scorecard.dev/projects/github.com/williajm/mcp_kafka/badge)](https://scorecard.dev/viewer/?uri=github.com/williajm/mcp_kafka) [![Bandit](https://github.com/williajm/mcp_kafka/actions/workflows/bandit.yml/badge.svg)](https://github.com/williajm/mcp_kafka/actions/workflows/bandit.yml) [![Dependabot](https://img.shields.io/badge/Dependabot-enabled-blue.svg?logo=dependabot)](https://github.com/williajm/mcp_kafka/security/dependabot) |

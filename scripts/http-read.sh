#!/bin/bash
# Start MCP Kafka HTTP server in READ-ONLY mode
# This server can only perform read operations (list topics, consume messages, etc.)
...
echo "Starting MCP Kafka HTTP Server (READ-ONLY mode)"
echo "================================================"
echo "  Host: $HOST"
echo "  Port: $PORT"
...
echo ""
echo "Available tools: READ operations only"
...
# Ensure write operations are disabled
export SAFETY_ALLOW_WRITE_OPERATIONS=false
